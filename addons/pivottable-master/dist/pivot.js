      ...
      try {
        ...
        fn = function(c) {
          ...
          if (keys.length > opts.menuLimit) {
            ...
            btns.append($("<button>", {
              type: "button",
              "class": "btn sm-btn btn-sm btn-default col-md-6"
            ...
            type:"text",
            placeholder:"класт",
            "class": "pvtDervived col-md-4"
        }).bind("keyup", function(){
            var deriverName = c + 'Класт' + $(this).val();
            
           console.log(opts.derivedAttributes);
           
            console.log(deriverName);
        }));
            
            btns.append($("<input>", {
              type: "text",
              placeholder: opts.localeStrings.filterResults,
              "class": "pvtSearch col-md-8 "
            }).bind("keyup", function() {
              var filter;
