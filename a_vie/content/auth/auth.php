        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-4 col-xs-12" style="text-align: center;">
                ...
                <form class="form-signin ajax" method="post" action="addons/php-auth/ajax.php">
                    ...
                    <h4 class="form-signin-heading">Форма входа</h4>
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input name="password" type="password" class="input-block-level input-sm form-control" placeholder="Пароль">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            ...
                            <button class="btn btn-large btn-blue" type="submit">Войти</button>
                        </div>
                    </div>
                    <div class="alert alert-info" style="margin-top:15px;">
                        <a class="link-menu" href="auth/register">Регистрация</a>
                    </div>
                </form>
            </div>
            <div class="hidden-lg hidden-lg col-sm-4 hidden-xs"></div>
